"""Qwen2.5-1.5B BoolQ eval under NeuPerm + noise + PTQ + Prune baselines.
Mirrors exp_qwen_squad.py but swaps SQuAD F1 for BoolQ accuracy. 5 seeds.
"""
...
from neu_perm.utils import load_boolq_ds, eval_on_boolq_ds
...
SEEDS = list(range(5))
DEVICE = "cuda"
CSV_PATH = os.path.join(RESULTS_DIR, "qwen_boolq.csv")
