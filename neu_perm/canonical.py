...
# ---------------------------------------------------------------------------
# MBConv families (EfficientNet, MobileNet)
#
# ``MBCONV_SITE_SPECS`` transcribes, in call order, the permutation sites of
# ``perm.efficientnet_b0`` / ``perm.efficientnet_b4`` / ``perm.mobilenet_v2`` /
# ``perm.mobilenet_v3_small``. Each entry consumes exactly one
# ``get_perm_idxs`` draw, so entry *i* corresponds to recorded permutation *i*
# -- the 1:1 correspondence ``steganography._map_perm_indices_to_sites``
# asserts.
#
# Three spec forms, mapping onto the two pre-existing CNN site kinds. There is
# no MBConv-specific kind on purpose: the attacker's canonical key must be
# defined identically across architectures or the results table stops being a
# comparison, so the key is always taken from the *first* layer of the site.
#
#   ("pair", layer1, layer2)
#       ``perm.permute_layers`` -- a squeeze-and-excitation ``fc1 -> fc2``
#       hidden dimension, or MobileNetV3-Small's classifier MLP pair. Same
#       (weight rows, bias, next-layer input axis) structure as a VGG layer
#       pair, hence ``vgg_pair``.
#
#   ("cbc", conv1, bn, conv2)
#       ``perm.permute_conv_bn_conv`` -- structurally identical to the
#       ResNet/DenseNet sites, hence ``conv_bn_conv``.
#
#   ("mbconv", expand_conv, expand_bn, project_conv)
#       ``perm.permute_mbconv_expanded`` -- the MBConv *expanded dimension*,
#       reordered as a closed ring by one shared draw: expansion conv output,
#       expansion BN, depthwise conv channel axis, depthwise BN, the SE fc1
#       input / fc2 output where an SE block is present, and the projection
#       conv input. The depthwise and SE tensors move with the same draw but
#       do not enter the canonical key: by the uniform rule that is computed
#       on the first convolution of the ring -- the expansion conv -- exactly
#       as a ``conv_bn_conv`` site does (weight reduced over all but the
#       output-channel dim for l1_norm/l2_norm/variance; the expansion BN
#       gamma for bias_value). So the site maps onto ``conv_bn_conv`` with
#       conv1 = expansion conv, bn = expansion BN, conv2 = projection conv.
# ---------------------------------------------------------------------------

MBCONV_SITE_SPECS = {
    "efficientnet_b0": [
        ("pair", "features.6.2.block.2.fc1", "features.6.2.block.2.fc2"),
        ("pair", "features.6.3.block.2.fc1", "features.6.3.block.2.fc2"),
        ("pair", "features.7.0.block.2.fc1", "features.7.0.block.2.fc2"),
        ("pair", "features.2.0.block.2.fc1", "features.2.0.block.2.fc2"),
        ("pair", "features.4.0.block.2.fc1", "features.4.0.block.2.fc2"),
        ("pair", "features.2.1.block.2.fc1", "features.2.1.block.2.fc2"),
        ("pair", "features.3.1.block.2.fc1", "features.3.1.block.2.fc2"),
        ("pair", "features.6.1.block.2.fc1", "features.6.1.block.2.fc2"),
        ("pair", "features.5.0.block.2.fc1", "features.5.0.block.2.fc2"),
        ("pair", "features.5.1.block.2.fc1", "features.5.1.block.2.fc2"),
        ("pair", "features.6.0.block.2.fc1", "features.6.0.block.2.fc2"),
        ("pair", "features.5.2.block.2.fc1", "features.5.2.block.2.fc2"),
        ("pair", "features.4.2.block.2.fc1", "features.4.2.block.2.fc2"),
        ("pair", "features.1.0.block.1.fc1", "features.1.0.block.1.fc2"),
        ("pair", "features.3.0.block.2.fc1", "features.3.0.block.2.fc2"),
        ("pair", "features.4.1.block.2.fc1", "features.4.1.block.2.fc2"),
        ("mbconv", "features.2.0.block.0.0", "features.2.0.block.0.1", "features.2.0.block.3.0"),
        ("mbconv", "features.2.1.block.0.0", "features.2.1.block.0.1", "features.2.1.block.3.0"),
        ("mbconv", "features.3.0.block.0.0", "features.3.0.block.0.1", "features.3.0.block.3.0"),
        ("mbconv", "features.3.1.block.0.0", "features.3.1.block.0.1", "features.3.1.block.3.0"),
        ("mbconv", "features.4.0.block.0.0", "features.4.0.block.0.1", "features.4.0.block.3.0"),
        ("mbconv", "features.4.1.block.0.0", "features.4.1.block.0.1", "features.4.1.block.3.0"),
        ("mbconv", "features.4.2.block.0.0", "features.4.2.block.0.1", "features.4.2.block.3.0"),
        ("mbconv", "features.5.0.block.0.0", "features.5.0.block.0.1", "features.5.0.block.3.0"),
        ("mbconv", "features.5.1.block.0.0", "features.5.1.block.0.1", "features.5.1.block.3.0"),
        ("mbconv", "features.5.2.block.0.0", "features.5.2.block.0.1", "features.5.2.block.3.0"),
        ("mbconv", "features.6.0.block.0.0", "features.6.0.block.0.1", "features.6.0.block.3.0"),
        ("mbconv", "features.6.1.block.0.0", "features.6.1.block.0.1", "features.6.1.block.3.0"),
        ("mbconv", "features.6.2.block.0.0", "features.6.2.block.0.1", "features.6.2.block.3.0"),
        ("mbconv", "features.6.3.block.0.0", "features.6.3.block.0.1", "features.6.3.block.3.0"),
        ("mbconv", "features.7.0.block.0.0", "features.7.0.block.0.1", "features.7.0.block.3.0"),
    ],
    "efficientnet_b4": [
        ("pair", "features.6.5.block.2.fc1", "features.6.5.block.2.fc2"),
        ("pair", "features.1.1.block.1.fc1", "features.1.1.block.1.fc2"),
        ("pair", "features.4.4.block.2.fc1", "features.4.4.block.2.fc2"),
        ("pair", "features.2.0.block.2.fc1", "features.2.0.block.2.fc2"),
        ("pair", "features.2.2.block.2.fc1", "features.2.2.block.2.fc2"),
        ("pair", "features.2.1.block.2.fc1", "features.2.1.block.2.fc2"),
        ("pair", "features.5.3.block.2.fc1", "features.5.3.block.2.fc2"),
        ("pair", "features.6.0.block.2.fc1", "features.6.0.block.2.fc2"),
        ("pair", "features.1.0.block.1.fc1", "features.1.0.block.1.fc2"),
        ("pair", "features.3.3.block.2.fc1", "features.3.3.block.2.fc2"),
        ("pair", "features.5.0.block.2.fc1", "features.5.0.block.2.fc2"),
        ("pair", "features.5.2.block.2.fc1", "features.5.2.block.2.fc2"),
        ("pair", "features.4.2.block.2.fc1", "features.4.2.block.2.fc2"),
        ("pair", "features.3.1.block.2.fc1", "features.3.1.block.2.fc2"),
        ("pair", "features.5.5.block.2.fc1", "features.5.5.block.2.fc2"),
        ("pair", "features.5.4.block.2.fc1", "features.5.4.block.2.fc2"),
        ("pair", "features.6.3.block.2.fc1", "features.6.3.block.2.fc2"),
        ("pair", "features.6.7.block.2.fc1", "features.6.7.block.2.fc2"),
        ("pair", "features.7.1.block.2.fc1", "features.7.1.block.2.fc2"),
        ("pair", "features.5.1.block.2.fc1", "features.5.1.block.2.fc2"),
        ("pair", "features.7.0.block.2.fc1", "features.7.0.block.2.fc2"),
        ("pair", "features.6.6.block.2.fc1", "features.6.6.block.2.fc2"),
        ("pair", "features.6.2.block.2.fc1", "features.6.2.block.2.fc2"),
        ("pair", "features.6.1.block.2.fc1", "features.6.1.block.2.fc2"),
        ("pair", "features.6.4.block.2.fc1", "features.6.4.block.2.fc2"),
        ("pair", "features.4.1.block.2.fc1", "features.4.1.block.2.fc2"),
        ("pair", "features.2.3.block.2.fc1", "features.2.3.block.2.fc2"),
        ("pair", "features.3.0.block.2.fc1", "features.3.0.block.2.fc2"),
        ("pair", "features.3.2.block.2.fc1", "features.3.2.block.2.fc2"),
        ("pair", "features.4.5.block.2.fc1", "features.4.5.block.2.fc2"),
        ("pair", "features.4.0.block.2.fc1", "features.4.0.block.2.fc2"),
        ("pair", "features.4.3.block.2.fc1", "features.4.3.block.2.fc2"),
        ("mbconv", "features.2.0.block.0.0", "features.2.0.block.0.1", "features.2.0.block.3.0"),
        ("mbconv", "features.2.1.block.0.0", "features.2.1.block.0.1", "features.2.1.block.3.0"),
        ("mbconv", "features.2.2.block.0.0", "features.2.2.block.0.1", "features.2.2.block.3.0"),
        ("mbconv", "features.2.3.block.0.0", "features.2.3.block.0.1", "features.2.3.block.3.0"),
        ("mbconv", "features.3.0.block.0.0", "features.3.0.block.0.1", "features.3.0.block.3.0"),
        ("mbconv", "features.3.1.block.0.0", "features.3.1.block.0.1", "features.3.1.block.3.0"),
        ("mbconv", "features.3.2.block.0.0", "features.3.2.block.0.1", "features.3.2.block.3.0"),
        ("mbconv", "features.3.3.block.0.0", "features.3.3.block.0.1", "features.3.3.block.3.0"),
        ("mbconv", "features.4.0.block.0.0", "features.4.0.block.0.1", "features.4.0.block.3.0"),
        ("mbconv", "features.4.1.block.0.0", "features.4.1.block.0.1", "features.4.1.block.3.0"),
        ("mbconv", "features.4.2.block.0.0", "features.4.2.block.0.1", "features.4.2.block.3.0"),
        ("mbconv", "features.4.3.block.0.0", "features.4.3.block.0.1", "features.4.3.block.3.0"),
        ("mbconv", "features.4.4.block.0.0", "features.4.4.block.0.1", "features.4.4.block.3.0"),
        ("mbconv", "features.4.5.block.0.0", "features.4.5.block.0.1", "features.4.5.block.3.0"),
        ("mbconv", "features.5.0.block.0.0", "features.5.0.block.0.1", "features.5.0.block.3.0"),
        ("mbconv", "features.5.1.block.0.0", "features.5.1.block.0.1", "features.5.1.block.3.0"),
        ("mbconv", "features.5.2.block.0.0", "features.5.2.block.0.1", "features.5.2.block.3.0"),
        ("mbconv", "features.5.3.block.0.0", "features.5.3.block.0.1", "features.5.3.block.3.0"),
        ("mbconv", "features.5.4.block.0.0", "features.5.4.block.0.1", "features.5.4.block.3.0"),
        ("mbconv", "features.5.5.block.0.0", "features.5.5.block.0.1", "features.5.5.block.3.0"),
        ("mbconv", "features.6.0.block.0.0", "features.6.0.block.0.1", "features.6.0.block.3.0"),
        ("mbconv", "features.6.1.block.0.0", "features.6.1.block.0.1", "features.6.1.block.3.0"),
        ("mbconv", "features.6.2.block.0.0", "features.6.2.block.0.1", "features.6.2.block.3.0"),
        ("mbconv", "features.6.3.block.0.0", "features.6.3.block.0.1", "features.6.3.block.3.0"),
        ("mbconv", "features.6.4.block.0.0", "features.6.4.block.0.1", "features.6.4.block.3.0"),
        ("mbconv", "features.6.5.block.0.0", "features.6.5.block.0.1", "features.6.5.block.3.0"),
        ("mbconv", "features.6.6.block.0.0", "features.6.6.block.0.1", "features.6.6.block.3.0"),
        ("mbconv", "features.6.7.block.0.0", "features.6.7.block.0.1", "features.6.7.block.3.0"),
        ("mbconv", "features.7.0.block.0.0", "features.7.0.block.0.1", "features.7.0.block.3.0"),
        ("mbconv", "features.7.1.block.0.0", "features.7.1.block.0.1", "features.7.1.block.3.0"),
    ],
    "mobilenet_v2": [
        ("mbconv", "features.2.conv.0.0", "features.2.conv.0.1", "features.2.conv.2"),
        ("mbconv", "features.3.conv.0.0", "features.3.conv.0.1", "features.3.conv.2"),
        ("mbconv", "features.4.conv.0.0", "features.4.conv.0.1", "features.4.conv.2"),
        ("mbconv", "features.5.conv.0.0", "features.5.conv.0.1", "features.5.conv.2"),
        ("mbconv", "features.6.conv.0.0", "features.6.conv.0.1", "features.6.conv.2"),
        ("mbconv", "features.7.conv.0.0", "features.7.conv.0.1", "features.7.conv.2"),
        ("mbconv", "features.8.conv.0.0", "features.8.conv.0.1", "features.8.conv.2"),
        ("mbconv", "features.9.conv.0.0", "features.9.conv.0.1", "features.9.conv.2"),
        ("mbconv", "features.10.conv.0.0", "features.10.conv.0.1", "features.10.conv.2"),
        ("mbconv", "features.11.conv.0.0", "features.11.conv.0.1", "features.11.conv.2"),
        ("mbconv", "features.12.conv.0.0", "features.12.conv.0.1", "features.12.conv.2"),
        ("mbconv", "features.13.conv.0.0", "features.13.conv.0.1", "features.13.conv.2"),
        ("mbconv", "features.14.conv.0.0", "features.14.conv.0.1", "features.14.conv.2"),
        ("mbconv", "features.15.conv.0.0", "features.15.conv.0.1", "features.15.conv.2"),
        ("mbconv", "features.16.conv.0.0", "features.16.conv.0.1", "features.16.conv.2"),
        ("mbconv", "features.17.conv.0.0", "features.17.conv.0.1", "features.17.conv.2"),
    ],
    "mobilenet_v3_small": [
        ("pair", "features.1.block.1.fc1", "features.1.block.1.fc2"),
        ("pair", "features.4.block.2.fc1", "features.4.block.2.fc2"),
        ("pair", "features.5.block.2.fc1", "features.5.block.2.fc2"),
        ("pair", "features.6.block.2.fc1", "features.6.block.2.fc2"),
        ("pair", "features.7.block.2.fc1", "features.7.block.2.fc2"),
        ("pair", "features.8.block.2.fc1", "features.8.block.2.fc2"),
        ("pair", "features.9.block.2.fc1", "features.9.block.2.fc2"),
        ("pair", "features.10.block.2.fc1", "features.10.block.2.fc2"),
        ("pair", "features.11.block.2.fc1", "features.11.block.2.fc2"),
        ("pair", "classifier.0", "classifier.3"),
        ("cbc", "features.1.block.2.0", "features.1.block.2.1", "features.2.block.0.0"),
    ],
}


def _mbconv_sites(model_type, key_prefix=""):
    """Build the PermSite list for an MBConv-family model from MBCONV_SITE_SPECS."""
    sites = []
    for spec in MBCONV_SITE_SPECS[model_type]:
        kind = spec[0]
        if kind == "pair":
            _, layer1, layer2 = spec
            sites.append(
                PermSite(
                    kind="vgg_pair",
                    keys={
                        "layer1_weight": f"{key_prefix}{layer1}.weight",
                        "layer1_bias": f"{key_prefix}{layer1}.bias",
                        "layer2_weight": f"{key_prefix}{layer2}.weight",
                    },
                )
            )
        elif kind in ("cbc", "mbconv"):
            _, conv1, bn, conv2 = spec
            sites.append(
                PermSite(
                    kind="conv_bn_conv",
                    keys={
                        "conv1_weight": f"{key_prefix}{conv1}.weight",
                        "bn_weight": f"{key_prefix}{bn}.weight",
                        "bn_bias": f"{key_prefix}{bn}.bias",
                        "bn_running_mean": f"{key_prefix}{bn}.running_mean",
                        "bn_running_var": f"{key_prefix}{bn}.running_var",
                        "conv2_weight": f"{key_prefix}{conv2}.weight",
                    },
                )
            )
        else:
            raise ValueError(f"Unknown MBConv site spec kind: {kind!r}")
    return sites
...
_sites_map = {
    ...
    "efficientnet_b0": partial(_mbconv_sites, "efficientnet_b0"),
    "efficientnet_b4": partial(_mbconv_sites, "efficientnet_b4"),
    "mobilenet_v2": partial(_mbconv_sites, "mobilenet_v2"),
    "mobilenet_v3_small": partial(_mbconv_sites, "mobilenet_v3_small"),
}
